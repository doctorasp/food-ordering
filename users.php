...
<head>
  ...
  .input-field label.active{
      width:100%;
         ...
         nav .nav-wrapper{
           background-color:#1C665F;
       }   
       .page-footer{
           background-color:#1C665F !important;
       }
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1">Суши Shop</a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
                ...
                <div class="col col s4 m4 l4">
				 ...
				 <div class="col col s8 m8 l8">
                    <ul id="profile-dropdown" class="dropdown-content">
                        <li><a href="routers/logout.php"><i class="mdi-hardware-keyboard-tab"></i> Вийти</a>
                        </li>
                    </ul>
                </div>
                <div class="col col s8 m8 l8">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Меню</a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Замовлення</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-orders.php">Всі замовлення</a>
                                </li>
								<?php
                 ...
                 <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Відгуки</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-tickets.php">Всі відгуки</a>
                                </li>
								<?php
            ...
            <li class="bold active"><a href="users.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Користувачі</a>
            </li>			
        </ul>
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Список користувачів</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Верифікація користувачів</p>
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/user-router.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Список користувачів</h4>
              </div>
              <div>
<table>
                    <thead>
                      <tr>
                        <th data-field="name">Назва</th>
                        <th data-field="price">Email</th>
                        <th data-field="price">Телефон</th>
                        <th data-field="price">Адреса</th>	
                        <th data-field="price">Роль</th>
                        <th data-field="price">Вериф.</th>
                        <th data-field="price">Дозволити</th>
                        <th data-field="price">Картка</th>						
                      </tr>
                    </thead>
			  ...
			  <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Редагувати
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/add-users.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Додати користувача</h4>
              </div>
              <div>
<table>
                    <thead>
                      <tr>
                        <th data-field="name">Логін</th>
                        ...
                        <th data-field="price">Роль</th>
                        <th data-field="price">Вериф.</th>
                        <th data-field="price">Дозволено</th>		
                      </tr>
                    </thead>
			  ...
			  <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Додати
                                <i class="mdi-content-send right"></i>
                              </button>
                            </div>
            </div>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2018 <a class="grey-text text-lighten-4" href="#" target="_blank">DUT</a> University</span>
        <span class="right"> Designed by Lebedev  <a class="grey-text text-lighten-4" href="#">Student</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
